...
bronze_path = f"abfss://{container_name}@{storage_account_name}.dfs.core.windows.net/delta/{dataset_path}"
...
while True:
    # Get the delta state
    delta_state_value = '2023-09-01T00:00' #delta_state.get_delta_state(default_value='2023-09-01T00:00')
